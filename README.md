[![Build Status](https://travis-ci.com/rogervinas/spring-boot-maven-assembly-sample.svg?branch=master)](https://travis-ci.com/rogervinas/spring-boot-maven-assembly-sample)
